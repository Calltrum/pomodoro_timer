...
def reset_timer():
    ...
    canvas.itemconfig(text_canv, text='00:00')
...
def count_down(count):
    ...
    canvas.itemconfig(text_canv, text=f'{count_min}:{count_secs}')
    if count > 0:
        global timer
...
text_canv = canvas.create_text(103, 130, text='00:00', fill='white', font=(FONT_NAME, 30, 'bold'))
